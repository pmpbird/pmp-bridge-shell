(()=>{
'use strict';
const V='1.0.9-pass7-final-audit-diagnostics-coverage-lock-aligned';
const SCRIPTS=[
  ...
  {id:'pmpOwnerDiagnosticsFoundationV1DirectFrame',src:'pmp-owner-diagnostics-foundation-v1.js',fresh:'pass7-patch5-audit-coverage-lock-visible-20260706E'},
