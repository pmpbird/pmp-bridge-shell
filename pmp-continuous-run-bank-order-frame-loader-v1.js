(()=>{
'use strict';
const V='1.1.1-pass7-certification-gate-diagnostics-aligned';
const SCRIPTS=[
  ...
  {id:'pmpOwnerDiagnosticsFoundationV1DirectFrame',src:'pmp-owner-diagnostics-foundation-v1.js',fresh:'pass7-patch6-audit-certification-gate-visible-20260706F'},
...
function scan(){let made=0;docs(document).forEach(d=>{made+=inject(d)});try{localStorage.setItem('pmp_continuous_run_bank_order_frame_loader_v1_receipt',JSON.stringify({type:'PMP_CONTINUOUS_RUN_BANK_ORDER_FRAME_LOADER_V1',version:V,at:now(),scripts:SCRIPTS.map(x=>x.src),new_injections:made,note:'Loads all Pass 7 passive systems through Certification Gate and Diagnostics Patch 6 without changing route/storage/engine/core logic.',pass7_patch1:'pmp-section-owner-registry-v1.js loaded as passive proof layer only',pass7_patch2:'pmp-owner-diagnostics-foundation-v1.js loaded as read-only diagnostics foundation',pass7_patch3:'pmp-helper-registry-v1.js loaded as passive helper truth table only',pass7_patch4:'pmp-universal-growth-awareness-v1.js loaded as passive growth awareness only',pass7_patch5:'pmp-pass7-coverage-lock-v1.js loaded as passive coverage lock only',pass7_patch6:'pmp-pass7-certification-gate-v1.js loaded as passive certification gate only',final_audit:'diagnostics_loader_tag_aligned_to_patch6_certification_gate_visible',side_effects:{route_change_attempted:false,indexeddb_write_attempted:false,bank_rebuild_attempted:false,storage_migration_attempted:false,section_takeover_attempted:false,diagnostic_repair_attempted:false,helper_takeover_attempted:false,growth_auto_create_attempted:false,coverage_lock_repair_attempted:false,certification_repair_attempted:false}},null,2))}catch(e){}}
window.PMPContinuousRunBankOrderFrameLoaderV1={version:V,scan,pass7_patch1:'loads passive section owner registry',pass7_patch2:'loads read-only owner diagnostics foundation',pass7_patch3:'loads passive helper registry',pass7_patch4:'loads passive universal growth awareness',pass7_patch5:'loads passive coverage lock',pass7_patch6:'loads passive certification gate',final_audit:'diagnostics fresh tag aligned to certification gate visible'};
