(()=>{
'use strict';
const V='1.0.5-level1plus-containment-guard';
const SCRIPTS=[
  ...
  {id:'pmpContinuousRunLevelUIScopeV1DirectFrame',src:'pmp-continuous-run-level-ui-scope-v1.js',fresh:'level-ui-scope-v119-level1plus-containment-guard-20260629F'}
];
