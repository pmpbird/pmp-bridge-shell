# Packet 01.5 — Discovery Status v7
...
- Current preserved plus provisional total: 354
...
- testing blind spots and weak oracles
- flaky tests and nondeterminism
- coverage illusion and missing negative tests
- contaminated test data
- mutation-testing gaps
- unit, integration, runtime, and real-device mismatch
- proof-chain breaks
- false PASS caused by test infrastructure

END PACKET 01.5 — DISCOVERY STATUS v7
