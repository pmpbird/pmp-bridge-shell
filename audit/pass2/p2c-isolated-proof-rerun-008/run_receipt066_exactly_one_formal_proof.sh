...
seal_path=root/'P2C_RECEIPT066_FORMAL_PROOF_PR_HEAD_SEAL_068.json'
...
assert auth['prepare_argument_proxy_git_blob_sha']==blob(pathlib.Path(auth['prepare_argument_proxy_path']))
