...
def main() -> None:
    ...
    seal.update(
        ...
        sealed_branch="agent/pass7-unit4-owner-mount-diagnostics-integration-v1",
        pass7_context=(
            "P7-U4 production-loads a passive capability-bound Section Owner event "
            "adapter under mount_registry_owner and a redacted read-only Diagnostics "
            "view. Appearance grants no authority; no mount, route, Bank, repair, "
            "storage migration, or persisted-user-data effect is introduced."
        ),
    )
    ...
    print("PASS: P7-U4 runtime integrity identities regenerated")
