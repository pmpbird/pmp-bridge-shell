...
def main() -> None:
    ...
    seal.update(
        ...
        sealed_branch="agent/pass8-unit4-helper-owner-diagnostics-integration-v1",
        pass8_context=(
            "P8-U4 production-loads a passive explicit Helper registration adapter "
            "under the exact P8-U2 capability and P8-U3 event contracts, requires "
            "the canonical Section Owner registration, and exposes only a bounded "
            "redacted Diagnostics view. No Helper behavior, Bank mutation, route, "
            "mount, repair, storage migration, or persisted-user-data effect is activated."
        ),
    )
    ...
    print("PASS: P8-U4 runtime integrity identities regenerated")
