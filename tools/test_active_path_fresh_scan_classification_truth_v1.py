...
checks = {
    'machine_version': "1.5.0-served-a003-reference-truth-20260826A" in machine,
    'machine_revision': "1.1.0-served-a003-reference-truth-20260826A" in machine,
    ...
    'exporter_exact_machine': "EXPECTED_MACHINE_VERSION='1.5.0-served-a003-reference-truth-20260826A'" in exporter and "EXPECTED_MACHINE_REVISION='1.1.0-served-a003-reference-truth-20260826A'" in exporter,
    ...
    'no_forced_pass': 'freeze_gate:{pass:policy.map_fetch_ok&&integrity.fetch_ok&&!!integrity.manifest_sha256' in machine,
