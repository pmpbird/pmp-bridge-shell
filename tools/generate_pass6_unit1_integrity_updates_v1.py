...
CONTRACT='pmp-diagnostic-journal-contract-v1.js'
...
def record(path:str,existing:dict|None=None)->dict:
    ...
    result.update({
        ...
        'execution_class':'EXECUTABLE_SCRIPT',
...
def main():
    ...
    index[CONTRACT]=record(CONTRACT,index.get(CONTRACT))
    ...
    seal.update(
        ...
        sealed_branch='agent/pass6-unit1-diagnostic-journal-contract-v1',
        pass6_context='Pass 6 Unit 1 adds a pure unreferenced diagnostic journal contract. It is integrity-listed but not production-loaded and performs no storage, network, DOM, route, repair, export, or persisted-user-data effect.',
    )
    seal.pop('pass5_context',None)
    SEAL.write_text(
    ...
    print('PASS: Pass 6 Unit 1 integrity identities regenerated')
