...
RUNTIME = "pmp-section-owner-mount-integration-v1.js"
...
def main() -> None:
    ...
    index[RUNTIME] = record(RUNTIME, index[RUNTIME])
    ...
    seal.update(
        ...
        sealed_branch="agent/pass7-unit5-owner-isolation-restart-denial-proof-v1",
        pass7_context=(
            "P7-U5 binds each registration event to the exact owner capability "
            "and adds atomic fail-closed restart journal replay. Duplicate, stale, "
            "growth, and denial paths retain zero mount, route, Bank, repair, "
            "storage, or persisted-user-data effects."
        ),
    )
    ...
    print("PASS: P7-U5 runtime integrity identities regenerated")
