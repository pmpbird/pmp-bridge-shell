...
def main() -> None:
    ...
    seal.update(
        ...
        sealed_branch="agent/pass10-unit7-legacy-level-alias-repair-v1",
        pass10_context=(
            "P10-U7S maps the real legacy Level 19, 21, 23, 25, and 27 DOM "
            "aliases into their one canonical level shell, contains redundant "
            "legacy badges, and leaves hidden mount sentinels so recurring "
            "legacy helpers cannot recreate duplicate controls under Level 4. "
            "The Pass 9 Locked / waiting fail-closed readiness state is "
            "preserved. The repair does not read, write, delete, migrate, or "
    ...
    print("PASS: P10-U7S legacy level-alias runtime integrity identities regenerated")
