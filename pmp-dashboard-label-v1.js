(()=>{
  if(window.PMPDashboardLabelV2)return;
  window.PMPDashboardLabelV2=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r1'))return;let s=d.createElement('script');s.id='pmp-card-loader-r1';s.src='pmp-crd-card-v1.js?fresh=r1';(d.head||d.documentElement).appendChild(s)}catch(e){}}
