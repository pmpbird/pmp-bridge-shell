(()=>{
  if(window.PMPDashboardLabelV4)return;
  window.PMPDashboardLabelV4=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r3'))return;let s=d.createElement('script');s.id='pmp-card-loader-r3';s.src='pmp-crd-card-v1.js?fresh=r3';(d.head||d.documentElement).appendChild(s)}catch(e){}}
