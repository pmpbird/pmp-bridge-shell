(()=>{
  if(window.PMPDashboardLabelV8)return;
  window.PMPDashboardLabelV8=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r7'))return;let s=d.createElement('script');s.id='pmp-card-loader-r7';s.src='pmp-crd-card-v1.js?fresh=r7';(d.head||d.documentElement).appendChild(s)}catch(e){}}
