(()=>{
  if(window.PMPDashboardLabelV7)return;
  window.PMPDashboardLabelV7=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r6'))return;let s=d.createElement('script');s.id='pmp-card-loader-r6';s.src='pmp-crd-card-v1.js?fresh=r6';(d.head||d.documentElement).appendChild(s)}catch(e){}}
