(()=>{
  if(window.PMPDashboardLabelV10)return;
  window.PMPDashboardLabelV10=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r9'))return;let s=d.createElement('script');s.id='pmp-card-loader-r9';s.src='pmp-crd-card-v1.js?fresh=r9';(d.head||d.documentElement).appendChild(s)}catch(e){}}
