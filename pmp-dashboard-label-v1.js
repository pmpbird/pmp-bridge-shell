(()=>{
  if(window.PMPDashboardLabelV6)return;
  window.PMPDashboardLabelV6=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r5'))return;let s=d.createElement('script');s.id='pmp-card-loader-r5';s.src='pmp-crd-card-v1.js?fresh=r5';(d.head||d.documentElement).appendChild(s)}catch(e){}}
