(()=>{
  if(window.PMPDashboardLabelV9)return;
  window.PMPDashboardLabelV9=true;
  ...
  function load(d){try{if(d.getElementById('pmp-card-loader-r8'))return;let s=d.createElement('script');s.id='pmp-card-loader-r8';s.src='pmp-crd-card-v1.js?fresh=r8';(d.head||d.documentElement).appendChild(s)}catch(e){}}
