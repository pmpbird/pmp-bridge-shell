(()=>{
'use strict';
const V='1.0.0',OWNER='pmp-connections-bank-inventory-off-v1';
...
function cleanDoc(d){try{Array.from(d.querySelectorAll('button')).forEach(b=>{if(/bank inventory/i.test(text(b))){b.style.display='none';b.setAttribute('aria-hidden','true');b.setAttribute('data-bank-tab-home','true')}})}catch(e){}}
...
window.PMPConnectionsBankInventoryOffV1={version:V,owner:OWNER,scan};window.addEventListener('load',()=>[50,150,400,900,1800].forEach(t=>setTimeout(scan,t)));setInterval(scan,500);scan();
})();
