(()=>{
const V='1.0.0',SRC='pmp_packet_1_5_builder_source_v1',TXT='pmp_packet_1_5_packet_text_v1',UN='pmp_packet_1_5_units_v1',RUNNER='pmp_packet_1_5_continuous_runner_v1';
...
function restore(){let u=r(UN,[]),src=g(SRC)||g(TXT);if(ok(u))return{changed:false,total:u.length};if(src&&window.PMPP15BuilderFixV2&&window.PMPP15BuilderFixV2.save){try{u=window.PMPP15BuilderFixV2.save(src).units}catch(e){}}
...
window.addEventListener('load',()=>[50,200,600,1200,2400].forEach(t=>setTimeout(restore,t)));setInterval(restore,1000);restore();
})();