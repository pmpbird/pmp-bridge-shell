(()=>{
'use strict';
const V='2.0.2-pass2-atlas-adapter-v2-v26';
const OWNER='pmp-pass2-atlas-adapter-v2';
const FILES=['pmp-pass2-atlas-adapter-v2.js','pmp-authority-rules-v1.js','pmp-active-bug-found-contract-v1.js','pmp-bug-watch-passive-capture-v1.js','pmp-current-inner-cleanbug-rgcontrols-v25.html','pmp-current-inner-cleanbug-rgcontrols-v26.html'];
const BUCKET='ACTIVE_CURRENT_APP';
function uniq(a){return Array.from(new Set((a||[]).filter(Boolean)));}
function clone(x){try{return JSON.parse(JSON.stringify(x||{}))}catch(e){return {}}}
function fileOwner(p){return p.indexOf('bug-watch')>-1?'Bug Watch Passive Capture':p.indexOf('contract')>-1?'Active Bug Found Contract':p.indexOf('v25')>-1||p.indexOf('v26')>-1?'Pass 2 Shell':'Pass 2 Authority'}
